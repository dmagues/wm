 ...
 */
package es.uam.irg.nlp.syntax.treebank;

import java.util.ArrayList;
import java.util.HashMap;
import java.util.List;
import java.util.Map;
import es.uam.irg.nlp.syntax.phrase.PhraseTags;
...
public class SyntacticTreebank {
    ...
    public SyntacticTreebank(String pennTreebankDescripion, boolean compactFormat) throws Exception {
        this.nodes = new HashMap<Integer, SyntacticTreebankNode>();
    ...
    public List<SyntacticTreebankNode> getChildrenNodesOf(int nodeId) throws Exception {
        ...
        List<SyntacticTreebankNode> childrenNodes = new ArrayList<SyntacticTreebankNode>();
